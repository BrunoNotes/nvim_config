...
vim.keymap.set("v", "<leader>x", function()
    vim.cmd(":. lua")
end, { silent = true, desc = "Execute current line" })
...
vim.keymap.set("n", "<ESC>", function()
    vim.cmd("nohlsearch")
end, { desc = "Clear highlights on search" })
...
end, { desc = "Activate spell check" })

vim.keymap.set("n", "<leader>sr", function()
    vim.cmd(":spellr")
end, { desc = "Repeat spell correction to matching words" })
